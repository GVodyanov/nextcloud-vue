...
export default {
	...
	methods: {
		initFocusTrap() {
			...
			// Manually add poppover, because it is mounted outside of the sidebar and handle keydown events there
			this.focusTrap = createFocusTrap([this.$refs.sidebar, '.v-popper__popper'], {
